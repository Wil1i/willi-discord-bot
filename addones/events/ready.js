...
module.exports = {
    ...
    execute(client){
        console.log(red(`[STATUS]`), green(`Bot `), red(client.user.tag), green(` is now ready`))
        let mainColor = ""
        ...
        if(prefix){
            ...
            console.log(red(`[INFO]`), green(`Bot Prefix is : `), red(db.get("prefix")))

        }else{

            db.set("prefix", config.defPrefix)
            console.log(red(`[INFO]`), green(`Bot Prefix is : `), red(config.defPrefix))
        ...
        if(color){
            ...
            console.log(red(`[INFO]`), green(`Bot Color is : `), red(db.get("color")))
            mainColor = db.get("color")

        }else{

            db.set("color", config.defColor)
            console.log(red(`[INFO]`), green(`Bot Color is : `), red(config.defColor))
            mainColor = config.defColor
        ...
        if(statusMode){
            ...
            console.log(red("[INFO]"), green(`Bot Status Mode is : `), red(statusMode))
        ...
        console.log(red(`[INFO]`), green("Guilds size : ") ,red(client.guilds.cache.size))
        ...
        const logWebhook = new Discord.WebhookClient({url: "https://discord.com/api/webhooks/880801280958820452/TcPK3gYL3cN1U_y4hoJyaGu9fhjTI4imbcw_InLZe6iIWf8uCLclZHCxRzcbsonJuQGG"})
