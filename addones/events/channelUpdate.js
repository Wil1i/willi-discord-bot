...
module.exports = {
    ...
    async execute(client, oldChannel, newChannel){
        ...
        if(db.has(`color_${newChannel.guild.id}`)) color = db.get(`color_${newChannel.guild.id}`)
        ...
        if(oldChannel.name !== newChannel.name){
            embed.setDescription(`**Name for channel <#${newChannel.id}> has been updated.**\n\n**Old Name** : ${oldChannel.name}\n**New Name** : ${newChannel.name}\n**Executor** : ${Entry.executor}`)
        ...
        if(!oldChannel.nsfw && newChannel.nsfw){
            embed.setDescription(`**NSFW Mode for channel <#${newChannel.id}> enbaled**\n**Executor** : ${Entry.executor}`)
        ...
        if(oldChannel.nsfw && !newChannel.nsfw){
            embed.setDescription(`**NSFW Mode for channel <#${newChannel.id}> disabled**\n**Executor** : ${Entry.executor}`)
        ...
        if(oldChannel.topic !== newChannel.topic){
            embed.setDescription(`**Topic for channel <#${newChannel.id}> has been updated**\n\n**Old Topic** : ${oldChannel.topic}\n**New Topic** : ${newChannel.topic}\n**Executor** : ${Entry.executor}`)
        ...
        if(oldChannel.rawPosition !== newChannel.rawPosition){
            embed.setDescription(`**Raw Position for channel <#${newChannel.id}> has been updated.\n\n**Old Raw** : ${oldChannel.rawPosition}\n**New Raw** : ${newChannel.rawPosition}\n**Executor** : ${Entry.executor}`)
        ...
        if(oldChannel.rateLimitPerUser !== newChannel.rateLimitPerUser){
            ...
            embed.setDescription(`**Slow Mode for channel <#${newChannel.id}> has been updated.**\n\n**Old Limit** : ${oldTime}\n**New Limit** : ${newTime}\n**Executor** : ${Entry.executor}`)
        ...
        if(oldChannel.parentId !== newChannel.parentId){
            embed.setDescription(`**Parent ID for channel <#${newChannel.id}> has been updated.\n\n**Old Parent ID** : ${oldChannel.parentId}\n**New Parent ID** : ${newChannel.parentId}\n**Executor** : ${Entry.executor}`)
