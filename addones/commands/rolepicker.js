...
module.exports = {
    ...
    execute(client, message){
        ...
        message.channel.send({content : "Jensiat khod ra entekhab konid.", components : [jensiat]})
        ...
        message.channel.send({content : "Console khod ra entekhab konid.", components : [platform]})
        ...
        message.channel.send({content : "Platform khod ra entekhab konid.", components : [viewer]})
        ...
        message.channel.send({content : "Game khod ra entekhab konid.", components : [game]})
