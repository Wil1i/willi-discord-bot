module.exports = {
  ...
  async execute(client, interaction) {
    ...
    if (interaction.values[0] == "jensiat-getleman") {
      if (findUser.roles.cache.has("675750321447764007"))
        findUser.roles.remove("675750321447764007");
      findUser.roles.add("675750376582152202");

      await interaction.reply({
        content: "Role Gentleman gived to you",
        ephemeral: true,
      });
      return;
    } else if (interaction.values[0] == "jensiat-lady") {
      if (findUser.roles.cache.has("675750376582152202"))
        findUser.roles.remove("675750376582152202");
      findUser.roles.add("675750321447764007s");

      await interaction.reply({
        content: "Role Lady gived to you",
        ephemeral: true,
      });
      return;
      ...
      await interaction.reply({
        content: "Role Mobile Player gived to you",
        ephemeral: true,
      });
      return;
      ...
      await interaction.reply({
        content: "Role PC Player gived to you",
        ephemeral: true,
      });
      return;
      ...
      await interaction.reply({
        content: "Role PlayStation Player gived to you",
        ephemeral: true,
      });
      return;
      ...
      await interaction.reply({
        content: "Role X-Box Player gived to you",
        ephemeral: true,
      });
      return;
      ...
      await interaction.reply({
        content: "Role YouTube Viewer gived to you",
        ephemeral: true,
      });
      return;
      ...
      await interaction.reply({
        content: "Role Aparat Viewer gived to you",
        ephemeral: true,
      });
      return;
      ...
      await interaction.reply({
        content: "Role Rainbow Player gived to you",
        ephemeral: true,
      });
      return;
      ...
      await interaction.reply({
        content: "Role Pubg Player gived to you",
        ephemeral: true,
      });
      return;
      ...
      await interaction.reply({
        content: "Role Fortnite Player gived to you",
        ephemeral: true,
      });
      return;
      ...
      await interaction.reply({
        content: "Role GTA Player gived to you",
        ephemeral: true,
      });
      return;
    }
